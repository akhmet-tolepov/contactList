...
//        if let arrayOfContacts = UserDefaults.standard.array(forKey: "contactsArray") as? [String] {
//            array = arrayOfContacts
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        if editingStyle == .delete {
            ...
            do {
                let encodedData = try JSONEncoder().encode(arrayOfContacts)
                UserDefaults.standard.set(encodedData, forKey: "contactArray")
            } catch {
                print(" Failed to save updated contacts: \(error)")
            }
